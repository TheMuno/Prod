...
$mainForm[0].querySelector('input[type=submit]').addEventListener('click', async e => {
  ...
  if (!capacity) {
    ...
    showError(`Sorry, we don't currently have capacity available before your arrival date ${arrivalDate}. Take a look at our pre-built guides or free trip planner for more.`);
    return; 
  }
  else {
