...
// Initialize Stripe
const stripe = Stripe("pk_test_51SV9kFBFhUWCg8lbck9k6f5YKBdRknXBIvs5XcElDp5U1HxQDTaqwyAHDoUm0vwKD3SkAQWEpNmIXAwpG6num6VB00nDePH5zo");

// Constants for server-side logic
const PRICE_STANDARD = "price_1SWxRQBFhUWCg8lblEixZvyY"; 
const PRICE_RUSH = "price_1SWxSBBFhUWCg8lbb8MowEMQ"; 
...
async function startCheckout() {
  ...
  if (!eventDate) {
      alert("Please select a valid starting date for your trip.");
      return;
  }
  ...
  try {
      ...
      const result = await createCheckout({
          ...
          // CRITICAL FIX: Send the CALCULATED price ID
      ...
      if (dataResp.error) {
          ...
          alert("Checkout failed: " + dataResp.error);
          return;
      }
      ...
      alert("An internal error prevented the checkout process.");
  }
}
...
const basePrice = setBasePrice; // set in webflow custom code section
const lessThan3WeeksPrice = setLessThan3WeeksPrice;
