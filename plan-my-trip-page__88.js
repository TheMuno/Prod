...
const PRICE_STANDARD = "price_1SbKPoBFhUWCg8lbcC2uiSda"; 
const PRICE_RUSH = "price_1SbKQRBFhUWCg8lbn41gmIGf";
...
$mainForm[0].querySelector('input[type=submit]').addEventListener('click', async e => {
  ...
  startCheckout(userData); 
});

function gatherUserDetails(emailField) {
  const phoneNumber = localStorage['ak-phone-num'] ? localStorage['ak-phone-num'] : 'No number set';
